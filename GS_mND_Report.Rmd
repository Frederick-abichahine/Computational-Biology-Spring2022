---
title: "A Protocol for Adjusting Measures of Differential Expression based on their Decay for Network Diffusion in Multi-Omic Analysis"
author: 
  - Bilal Hamdanieh^[bilal.hamdanieh@lau.edu]
  - Ghadi El Hasbani^[ghadi.elhasbani@lau.edu]
  - Frederick Abi Chahine^[frederick.abichahine@lau.edu]
...
## [2] ~ Loading Required Libraries {.tabset .tabset-fade .tabset-pills}
...
### [2.b] Loading Libraries {.tabset .tabset-fade}
...
## [3] ~ Protcol mND Only {.tabset .tabset-fade .tabset-pills}
...
## [4] ~ Proposed Protocol GS & mND {.tabset .tabset-fade .tabset-pills}
...
> 3. Replace DE Layer with Adjusted DE   
4. Run mND on the new Data with Adjusted Layer    
5. Save the Results & Compare with Previous Protocol

### [4.a] - Performing GeneSurrounder {.tabset .tabset-fade}
...
### [4.b] - Adjusting Scores {.tabset .tabset-fade}
...
### [4.c] - Visualizing Results {.tabset .tabset-fade}
```{r}
## Load the Results
data(X0)
...
### [4.d] - Running mND on Adjusted Scores {.tabset .tabset-fade}
```{r, eval = FALSE}
...
### [4.e] - Obtaining Results {.tabset .tabset-fade}
```{r}
## Load Data
## Adjacency Matrix
data(A)
...
## [5] ~ Analysis of Results {.tabset .tabset-fade .tabset-pills}

### [5.a] Classification Difference {.tabset .tabset-fade}
```{r}
## Sanity check:
...
### [5.b] Network Visualization {.tabset .tabset-fade}
...
### [5.c] Newly Found Genes {.tabset .tabset-fade}
...
### [5.d] Cumulative Decay Score {.tabset .tabset-fade}
...
## [6] ~ Coverage & Enrichment {.tabset .tabset-fade .tabset-pills}
